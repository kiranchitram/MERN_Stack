...
const Navbar = () => {
  ...
  return (
    ...
    items-center p-4 sm:p-6 sm:px-24 absolute top-0'>
    ...
    bg-black text-white relative group'>
      ...
      z-10 text-black rounded pt-10'>
        <ul className='list-none m-0 p-0 bg-gray-100 text-sm'>
          ...
          cursor-pointer'>Verify your Email</li> 
          }
    ...
    :
        ...
        rounded-full px-6 py-3 text-gray-800 hover:bg-green-400 transition-all'>
