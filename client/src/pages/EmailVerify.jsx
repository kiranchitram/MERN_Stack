  ...
  return (
    ...
    bg-gradient-to-br from-blue-200 to-purple-300'>
     <img onClick={()=>navigate('/')} src={assets.logo} alt="" 
            ...
            <form onSubmit={onSubmitHandler} className='bg-slate-900 
            p-8 rounded-lg shadow-lg w-96 text-sm'>
              <h1 className='text-center mb-6 text-white'>Email 
                Verify Otp</h1>

              <p className='text-center mb-6 text-indigo-300'>Enter the 6-digit
