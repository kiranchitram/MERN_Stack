...
const Login = () => {
  ...
  return (
    ...
    bg-gradient-to-br from-blue-200 to-purple-300'>
        ...
        <div className='bg-slate-900 p-10 rounded-lg shadow-lg
         w-full sm:w-96 text-indigo-300 text-sm '>

          <h2 className='text-3xl font-semibold text-white 
          text-center mb-3'>{state ==='Sign Up' ? 
          'Create Account' : 'Login'}</h2>

          <p className='text-center text-sm
           mb-6'>{state ==='Sign Up' ? 'Create Your Account' : 
          ...
          <form onSubmit={onSubitHandler}>
            ...
            className='mb-4 text-indigo-600 cursor-pointer'>Forgot 
              Password ?</p>
